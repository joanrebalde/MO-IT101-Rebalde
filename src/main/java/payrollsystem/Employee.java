...
public final class Employee extends javax.swing.JFrame {
    ...
    public Employee() {
        ...
        Object col [] = {"EmployeeID","FirstName","LastName","Birthdate","ContactNumber","Address","Status","Position",
            "Supervisor","BasicSalary","HourlyRate"};
        
        model.setColumnIdentifiers(col);
        jTable1.setModel(model);
        conn = Employee.ConnectDB();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee ID", "First Name", "Birthday", "Phone No", "Address", "Status", "Position", "Supervisor", "Basic Salary", "Hourly Rate"
            }
        ));
        ...
        jButton6.setBackground(new java.awt.Color(218, 223, 225));
        ...
        jButton8.setBackground(new java.awt.Color(218, 223, 225));
...
private JFrame frame;
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
       ...
       modl.setRowCount(0);
        ...
        String sql = "INSERT INTO employeedata (EmployeeID, FirstName, LastName, Birthdate, ContactNumber, Address, "
                + "Status, Position, Supervisor, BasicSalary,HourlyRate)VALUES(?,?,?,?,?,?,?,?,?,?,?)";
         try
    {
       pst = conn.prepareStatement(sql);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       modl.setRowCount(0);
        ...
        String sql = "UPDATE employeedata set FirstName=?, LastName=?, Birthdate=?, ContactNumber=?, Address=?, "
                + "Status=?, Position=?, Supervisor=?, BasicSalary=?, HourlyRate=? where EmployeeID=?";
         try
    {
       pst = conn.prepareStatement(sql);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
            try {
                ...
                jDateChooser1.setDate(new SimpleDateFormat ("dd/MM/yyyy").parse((String)model.getValueAt(SelectedRows, 3)));
                ...
                jComboBox1.setSelectedItem((String)model.getValueAt(SelectedRows, 6));
                jTextField11.setText(RecordTable.getValueAt(SelectedRows,7).toString());
                ...
                jTextField12.setText(RecordTable.getValueAt(SelectedRows,10).toString());
